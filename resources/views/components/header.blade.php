<header class="bg-green-800 text-white shadow-md sticky top-0 z-50">
    <div class="max-w-7xl mx-auto flex flex-wrap items-center justify-between px-4 py-3 gap-4">
        ...
        <div id="mobile-menu" class="w-full lg:w-auto hidden lg:flex flex-col lg:flex-row gap-4 lg:gap-6 items-center mt-4 lg:mt-0">
            ...
            <!-- Búsqueda -->
            <form action="#" method="get" class="w-full lg:w-auto flex items-center gap-2 mt-3 lg:mt-0">
                <input type="text" name="buscar" placeholder="Buscar..."
                       class="flex-1 px-3 py-2 rounded-md text-sm text-black focus:outline-none focus:ring focus:ring-green-300">
                <button type="submit"
                        class="bg-white text-green-800 px-4 py-2 rounded hover:bg-green-100 transition duration-300">
                    Buscar
                </button>
            </form>
        </div>
