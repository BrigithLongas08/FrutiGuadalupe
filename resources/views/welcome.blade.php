...
body {
    ...
    background-color: #f4f9f4; /* Color de fondo suave */
}
...
/* Encabezado */
.encabezado {
    background-color: #2b3a2a; /* Fondo oscuro */
    color: #f1e4e4; /* Texto claro */
...
.barra-navegacion {
    ...
    position: sticky; /* Fijar la barra al desplazarse */
...
.enlaces-navegacion {
    ...
    display: flex; /* Mostrar enlaces en una fila */
...
.barra-busqueda {
    ...
    justify-content: space-between; /* Espacio entre el campo de texto y el botón */
    max-width: 400px; /* Ancho máximo para la barra de búsqueda */
    margin: 0 auto; /* Centra la barra de búsqueda en la página */
    border: 1px solid #ccc; /* Bordes de la barra con color gris claro */
  ...
  .barra-busqueda input {
    ...
    outline: none; /* Quitamos el contorno cuando se selecciona el campo */
    padding: 5px; /* Espaciado interno */
    flex-grow: 1; /* El campo de texto ocupa el espacio restante */
  ...
  .barra-busqueda button {
    ...
    cursor: pointer; /* Cambia el cursor a mano cuando está sobre el botón */
    border-radius: 25px; /* Bordes redondeados */
    font-size: 16px; /* Tamaño de la fuente */
  }
  
  /* Estilo para cuando el cursor está sobre el botón (efecto hover) */
  .barra-busqueda button:hover {
    background-color: #45a049; /* Cambia el color de fondo del botón cuando se pasa el cursor */
  }
...
.enlaces-navegacion li a:hover {
    background-color: #4be25a; /* Fondo verde claro */
...
.productos {
    padding: 20px; /* Espaciado interno */
    background-color: #f4f9f4; /* Fondo claro */
    text-align: center; /* Centrar contenido */
}

/* Contenedor para las tarjetas de productos */
.cuadro-productos {
    display: flex; /* Usar flexbox para organizar productos */
    justify-content: center; /* Centrar horizontalmente */
    gap: 20px; /* Espacio entre tarjetas */
    margin-top: 20px; /* Separación del título */
    flex-wrap: wrap; /* Permitir que las tarjetas se ajusten en pantallas pequeñas */
}

/* Estilo individual de las tarjetas de productos */
.tarjeta-producto {
...
.tarjeta-producto button:hover {
    background-color: #45a049; /* Fondo verde oscuro */
}
...
.pie-pagina .iconos-sociales a img {
